...
import EventOrganiserHomePage from './EventOrganiserHomePage';
        ...
        <div className="app-container">
          <header>
            <div className="d-flex justify-content-between align-items-center p-2">
              <a id="Logo" className="text-white d-flex align-items-center" href="/">
                <img src={Logo} alt="VRV" />
          ...
          <main className="main-content">
            <Routes>
              ...
              <Route path="/profile" element={<EventOrganiserHomePage />} />
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a href="/Contactus" className="text-white">Get in Touch</a>
                    </li>
                  </ul>
                </div>
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a href="/PrivacyPolicy" className="text-white">Our Policy</a>
                    </li>
                  </ul>
                </div>
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a href="/terms" className="text-white">Read Terms</a>
                    </li>
                  </ul>
                </div>
              </div>
